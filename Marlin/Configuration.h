...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 44.94
    #define DEFAULT_Ki 5.53
    #define DEFAULT_Kd 91.23
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // from pid autotune. "M303 E-1 C8 S60" to run autotune on the bed at 60 degreesC for 8 cycles
    ...
    #define DEFAULT_bedKp 119.01
    #define DEFAULT_bedKi 20.95
    #define DEFAULT_bedKd 450.66
  #endif
 ...
 */
#define Z_MIN_PIN PE4 // Pin 32 is the RAMPS default
